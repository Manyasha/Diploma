...
def nonQvadFourStepsCGM(f, x0, eps):
    ...
    s = {
        0: lambda x_k: np.matrix(-sf.Gradient(f, x_k)),
        1: lambda x_k: -sf.Gradient(f, x_k) + sf.gamma_non_kvad(f, x_k, x_k, x_k_minus_n[0])*s_last[0],
        2: lambda x_k: -sf.Gradient(f, x_k) + sf.gamma_non_kvad(f, x_k, x_k, x_k_minus_n[1])*s_last[1] + sf.gamma_non_kvad(f, x_k, x_k_minus_n[1], x_k_minus_n[0])*s_last[0],
        3: lambda x_k: -sf.Gradient(f, x_k) + sf.gamma_non_kvad(f, x_k, x_k, x_k_minus_n[2])*s_last[2] + sf.gamma_non_kvad(f, x_k, x_k_minus_n[2], x_k_minus_n[1])*s_last[1] + sf.gamma_non_kvad(f, x_k, x_k_minus_n[1], x_k_minus_n[0])*s_last[0]
    }
    x_points = [x_k];   
